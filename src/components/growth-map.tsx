...
export function GrowthMap({
  ...
  if (collapsed) {
    return (
      <aside className="hidden lg:flex w-12 shrink-0 border-l bg-sidebar/50 flex-col items-center py-4 gap-3">
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8"
  ...
  return (
    <aside className="hidden lg:flex w-[340px] shrink-0 border-l bg-sidebar/50 overflow-y-auto flex-col">
      ...
      <GrowthMapBody data={data} progress={progress} />
    </aside>
  );
}

export function GrowthMapBody({
  data,
  progress,
}: {
  data: SessionMapData;
